...
/*********Promotion 22********************************/
//*****PROGRAMME DE TRAITEMEMT D'IMAGE********
...
void crbcorgam(float g){
	...
	for (float i =0.0;i<256.0;i++)
	{
	 ...
	 // Affichage et enregistrement de la courbe de la fonction
        ...
        cout<<"Erreur lors de l'enregistrement"<<endl;
        waitKey(4000);//Affichage de l'image pendant 2s
...
//Declaration des variables globales
	...
	{	do{
		...
		cout << "******************************************************************************** "<<endl;
		cout << "                                                                                 "<<endl;
		cout << "***********************PROGAMME DE TRAITEMENT D'IMAGES*************************  "<<endl;
                cout << "                                                                   "<<endl;
		cout << "    1-- Première partie : Profil d'intensité des pixels d'une ligne d’une image"<<endl;
		cout << "    2-- Deuxième partie : Modification des constrastes d'une image             "<<endl;
		cout << "    3-- Quitter le programme                                 "<<endl;
		cout << " Votre choix :  ";
		cin >> choixp;
		cout << "Donner le nom de votre image y compris avec l'extension et son chemin d'acces:"<<endl;
		cout << "$ ";
		cin  >> nomimg;
		...
		case 1:{cout << "                      "<<endl;
			cout << "                      "<<endl;
			cout << "       4--Traçage de l'histogramme de l'image originale                     "<<endl;
			cout << "       5--Traçage de la courbe du profil d'intensité    "<<endl;
			...
			//TraceHisto(nomimg);
			namedWindow("Histogramme de image",CV_WINDOW_AUTOSIZE);
                        imshow("Histogramme image",histoimgcont);
                        if(!imwrite("HistoOrigi.png",histoimgcont))
                        cout<<"Erreur lors de l'enregistrement"<<endl;
		...
		case 2: {
			...
			cout << "                                           "<<endl;
			cout << "                                           "<<endl;
                        cout << "       Modification du constraste d'une image"<<endl;
			cout << " ----------------------------------------------------"<<endl;
				...
				case 3: // Amélioration avec la correction gamma: fonction non linéaire
				  {
					...
					cout << " Amélioration du contraste avec une fonction non linéaire :la correction gamma"<<endl;
			...
			Mat printimgori=printimg(imgorig,vh,valign);
                        ...
                        if(!imwrite("profilIntenImgori.png",printimgori))
                        cout<<"Erreur lors de l'enregistrement"<<endl;
			...
			Mat traceimgori=tracelign(imgorig,vh,valign);
                        ...
                        if(!imwrite("traitImaori.png",traceimgori))
                        cout<<"Erreur lors de l'enregistrement"<<endl;
			...
			imshow("Profil d'intensite issu l image contrastee",printimgcont);
                        if(!imwrite("profilIntenImgCont.png",printimgcont))
                        cout<<"Erreur lors de l'enregistrement"<<endl;
